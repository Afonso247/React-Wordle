...
function App() {
  ...
  useEffect(() => {
    fetch('http://localhost:3001/solucoes')
      .then(res => res.json())
      .then(json => {
        // int aleatorio entre 0 e 17
        const solucaoRandom = json[Math.floor(Math.random() * json.length)];
        setSolucao(solucaoRandom.palavra);
      });
  }, [setSolucao]);
  return (
    <div className="App">
...
--- NPM AUDIT REALIZADO. SE ALGO DE ERRADO ACONTECER, CONSIDERE ESTA OPÇÃO ---
